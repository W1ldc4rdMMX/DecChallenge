 ...
 */
class stockTypes extends \AppBundle\Entity\stockTypes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (stockTypes $proxy) {
    ...
    public function getStockTypeName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getStockTypeName', []);

        return parent::getStockTypeName();
    }
